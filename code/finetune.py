...
class Reproduce(object):
    ...
    def run_train_epoch(self, dataloader):
        ...
        for batch_id, batch_data in enumerate(dataloader):
            ...
            logits = self.predictor(graph_embedding)   # 预测值
    ...
    def run(self):
        ...
        logger.info(f'sum_test: {sum_test} | n: {n}')
        logger.info(f'ave_test_score: {sum_test/n}')
...
# 'BACE', 'BBBP', 'Tox21', 'ToxCast', 'SIDER', 'ClinTox', 'HIV' ['FreeSolv', 'Lipophilicity', 'ESOL']:
    parser.add_argument('--data_name', type=str, default='ESOL')
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--featurizer_type', type=str, default='random')
    parser.add_argument('--num_workers', type=int, default=0)
    parser.add_argument('--split_type', type=str, default='random')
    parser.add_argument('--split_ratio', type=List, default=[0.8, 0.15, 0.05])
    
    parser.add_argument('--encoder_name', type=str, default='GNN') # ./dumped/0410-my_experiment/h5vmpbrhox-model/KMPNNGNN_0411_2114_390000th_epoch.pkl ./dumped/0410-my_experiment/h5vmpbrhox-model/Set2Set_0411_2114_390000th_epoch.pkl
    parser.add_argument('--encoder_path', type=str, default='./dumped/0413-my_experiment/n6isigq8jt-model/GCNNodeEncoder_0414_0943_216000th_epoch.pkl')
    parser.add_argument('--readout_path', type=str, default='./dumped/0413-my_experiment/n6isigq8jt-model/WeightedSumAndMax_0414_0943_216000th_epoch.pkl')
    parser.add_argument('--patience', type=int, default=300)

    parser.add_argument('--eval', type=str, default='nonfreeze')
    parser.add_argument('--predictor', type=str, default='nonlinear')
    ...
    parser.add_argument('--predictor_hidden_feats', type=int, default=32)

    parser.add_argument('--epoch_num', type=int, default=5000)
    parser.add_argument("--dump_path", default="./dump", type=str,
                        help="Experiment dump path")
    parser.add_argument("--exp_name", default="KG-finetune-kmpnn", type=str, #required=True,
                        help="Experiment name")
    parser.add_argument("--exp_id", default="FKECL", type=str,
                        help="Experiment ID")
